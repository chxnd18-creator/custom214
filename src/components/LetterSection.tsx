                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>ขอบคุณที่เค้ามาในชีวิตของเค้า ขอบคุณที่คอยช่วยเหลือคอยอยู่ข้างๆชีวิตเค้าสดใสมากเมื่อมีพงศ์เค้ามาในชีวิต
ขอบคุณที่คอยตามใจคอยเป็นห่วงพาเค้าไปกินของอร่อยพาไปนั่งรถเล่นขอบคุณที่เอ็นดูเค้าเค้าอยากจะขอโทษในสิ่งที่เค้าทำให้พงศ์ไม่สบายใจปากเหมือนจะไปแต่ใจจริงเค้าไม่เคยอยากไปจากพงศ์เลยเค้าแค่ต้องการความสนใจจากพงศ์เค้าพยายามปรับแล้วนะขอโทษที่ชอบทำให้เสียความรู้สึกเค้าชอบตอนที่ตัวเองอยู่กับพงศ์มากๆพงศ์ทำให้เค้าลืมความเศร้าเค้าโชคดีมากๆที่ได้เป็นแฟนพงศ์ เค้าจะรักพงศ์แค่คนเดียวและรักตลอดไปรักพงศ์มากๆเลย มากจนไม่สามารถบรรยายได้หมด อยู่กับเค้าตลอดไปเลยนะคะ 💓🥰</p>
                                    </div>
