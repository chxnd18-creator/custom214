...
const WISHES = [
  { id: 1,  text: "ดูหนัง",                color: "#ffd6e7" },
  { id: 2,  text: "อีสของอร่อย", color: "#fce4ec" },
  { id: 3,  text: "เค้านวดให้แฟน",        color: "#fff0f8" },
  { id: 4,  text: "ให้หนมไทเกอร์",           color: "#ffd6e7" },
  { id: 5,  text: "นั่งรถเล่น",          color: "#fce4ec" },
  { id: 6,  text: "ไปเดินเล่น",  color: "#fff0f8" },
  { id: 7,  text: "จุ๊บแก้ม",          color: "#ffd6e7" },
  { id: 8,  text: "กอดๆกัน",         color: "#fce4ec" },
  { id: 9,  text: "ไม่บอก",            color: "#fff0f8" },
  { id: 10, text: "ตามใจเค้า",            color: "#ffd6e7" },
];
